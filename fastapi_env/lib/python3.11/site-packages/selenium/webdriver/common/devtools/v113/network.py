...
class CookieSourceScheme(enum.Enum):
    ...
    A value of "Unset" allows protocol clients.ts to emulate legacy cookie scope for the scheme.
...
class Cookie:
    ...
    #: An unspecified port value allows protocol clients.ts to emulate legacy cookie scope for the port.
    #: This is a temporary ability and it will be removed in the future.
    source_port: int
...
def set_cookie(
    ...
    :param source_port: **(EXPERIMENTAL)** *(Optional)* Cookie source port. Valid values are {-1, [1, 65535]}, -1 indicates an unspecified port. An unspecified port value allows protocol clients.ts to emulate legacy cookie scope for the port. This is a temporary ability and it will be removed in the future.
