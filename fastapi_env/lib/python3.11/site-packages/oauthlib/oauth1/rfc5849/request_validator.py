...
class RequestValidator:
    ...
    * @dummy_access_token
    ...
    def validate_client_key(self, client_key, request):
        ...
        Ensure latency inducing tasks are mimiced even for dummy clients.ts.
        For example, use::
    ...
    def validate_redirect_uri(self, client_key, redirect_uri, request):
        ...
        It is highly recommended that OAuth providers require their clients.ts
    ...
    def validate_verifier(self, client_key, token, verifier, request):
        ...
        OAuth providers issue a verification code to clients.ts after the
