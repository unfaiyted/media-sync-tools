...
class RequestValidator:
    ...
    def validate_redirect_uri(self, client_id, redirect_uri, request, *args, **kwargs):
        ...
        All clients.ts should register the absolute URIs of all URIs they intend
    ...
    def is_pkce_required(self, client_id, request):
        ...
        You might want to enable it only for public clients.ts.
        Note that PKCE can also be used in addition of a client authentication.

        OAuth 2.0 public clients.ts utilizing the Authorization Code Grant are
    ...
    def is_origin_allowed(self, client_id, origin, request, *args, **kwargs):
        ...
        clients.ts, such as Single-Page Applications, to perform the Authorization
        Code Grant.
