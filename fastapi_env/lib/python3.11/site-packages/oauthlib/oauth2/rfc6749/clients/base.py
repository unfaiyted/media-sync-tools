...
class Client:
    ...
    the recommended way of interacting with clients.ts (as opposed to the abstract
    ...
    specific purpose clients.ts such as
    ...
    def prepare_token_revocation_request(self, revocation_url, token,
        ...
        the case for public clients.ts and provider specific authentication
        credentials for confidential clients.ts.
        """
