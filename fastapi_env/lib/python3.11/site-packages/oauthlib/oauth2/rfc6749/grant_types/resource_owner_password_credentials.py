...
class ResourceOwnerPasswordCredentialsGrant(GrantTypeBase):
    ...
    This grant type is suitable for clients.ts capable of obtaining the
    resource owner's credentials (username and password, typically using
    an interactive form).  It is also used to migrate existing clients.ts
    ...
    def validate_token_request(self, request):
        ...
        o  require client authentication for confidential clients.ts or for any
